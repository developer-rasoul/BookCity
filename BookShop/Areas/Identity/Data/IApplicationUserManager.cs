...
namespace BookShop.Areas.Identity.Data
{
    public interface IApplicationUserManager
    {
        ...
        Task<UsersViewModel> FindUserWithRoleByIdAsync(string id);
        Task<string> GetFullName(ClaimsPrincipal claimsPrincipal);
        Task<string> GetImage(ClaimsPrincipal claimsPrincipal);
